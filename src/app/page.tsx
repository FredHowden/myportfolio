...
export default function HomePage() {
    return (
        <main className="mt-30 mb-30 max-sm:mx-4 sm:mx-10 sm:max-md:mx-10 md:max-lg:mx-20 md:mx-32 ">
            <HeroSection />
            <AboutMeSection />
            <ProjectsSection />
            ...
            <section className="px-5">
                ...
                <div className="flex flex-wrap gap-8 mt-10">
                    ...
                    <div className="shadow-sm p-4 rounded-md flex-1">
                        ...
                        <ul className="grid grid-cols-2 xs:grid-cols-3 gap-8">
